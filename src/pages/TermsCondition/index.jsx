...
const TermsCondition = () => {
	return (
		<div className='terms-condition-use-wrapper'>
			<div className="container">
				<div className='pt-3'>
					<nav aria-label="breadcrumb">
						<ol className="breadcrumb">
							<li className="breadcrumb-item"><Link to="/">Home</Link></li>
							<li className="breadcrumb-item active" aria-current="page">Terms & Conditions Of Use</li>
						</ol>
					</nav>
				</div>
				<div className='terms-condition-use-main-wrapper'>
					<div className='terms-codition-use-wrapper2'>
						<div className='text-center terms-of-use-img'>
							<img src={termscondition} alt="img" className='img-fluid' />
						</div>
						<div className='terms-title'>
							<h4>Demo Template Terms of Conditions Use</h4>
						</div>
						<div>
							<h5>Generate Terms of Use for e-commerce stores</h5>
						...
						<div>
							<h5 className='mt-4'>Your Account and Registration Obligations</h5>
						...
						<div>
							...
							<p className='my-3'>Before shipping / delivering your order to you, Seller may request you to provide supporting documents (including but not limited to Govt. issued ID and address proof) to establish the ownership of the payment instrument used by you for your purchase. This is done in the interest of providing a safe online shopping environment to Our Users.</p>
